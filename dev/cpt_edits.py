...
def draw_menu():
    arcade.draw_text("DODGE ZOMBIES", 25, HEIGHT - 100, arcade.color.BANGLADESH_GREEN, 36, 2000, "Right", "Calibri", True)
    arcade.draw_text("Press Space to play", WIDTH / 3, HEIGHT / 10, arcade.color.BLACK)
    arcade.draw_text("How to Play(a)", WIDTH / 3, HEIGHT / 7, arcade.color.BLACK)
    arcade.draw_xywh_rectangle_filled(400, 400, 50, 50, arcade.color.BLACK)
    arcade.draw_xywh_rectangle_filled(50, 400, 50, 50, arcade.color.BLACK)
    arcade.draw_xywh_rectangle_filled(55, 430, 10, 10,arcade.color.WHITE)
    arcade.draw_xywh_rectangle_filled(405, 430, 10, 10, arcade.color.WHITE)
    arcade.draw_xywh_rectangle_filled(100, 200, 300,50, arcade.color.REDWOOD)
